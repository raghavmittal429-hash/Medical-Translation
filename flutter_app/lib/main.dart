      ...
      pdf.addPage(
        pw.MultiPage(
                ...
                children: [
                  pw.Column(
                      ...
                      children: [
                        ...
                        pw.Text(
                            'Generated by Medivaanii  \u2022  ${data['report_date'] ?? ""}',
          ...
          footer: (ctx) => pw.Row(
            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
            children: [
              pw.Text('Medivaanii \u2014 Confidential', style: _footerStyle),
          ...
          Card(
            child: ListTile(
              ...
              onTap: () {
                showAboutDialog(
                  context: context,
                  applicationName: 'Medivaanii',
                  applicationVersion: '2.0.0',
                  applicationLegalese: '© 2026 Medivaanii',
                );
              },
            ),
          ),
